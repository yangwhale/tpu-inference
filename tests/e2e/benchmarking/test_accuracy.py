...
orig_from_name = importlib.metadata.Distribution.from_name

def custom_from_name(cls, name: str):
    if name == 'vllm':
        try:
            return orig_from_name(name)
        except importlib.metadata.PackageNotFoundError:
            return orig_from_name("vllm-tpu")
    return orig_from_name(name)

importlib.metadata.Distribution.from_name = classmethod(custom_from_name)
